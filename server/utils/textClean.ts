...
/**
 * Conservative article text cleanup used for LLM prompts.
 *
 * Goals:
 * - Remove any remaining HTML tags (safety net)
 * - Collapse whitespace and excessive blank lines
 * - Cap length to keep token costs bounded
 *
 * IMPORTANT: Do not add speculative boilerplate-removal patterns here.
 */
