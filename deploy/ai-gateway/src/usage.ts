// Copy of server/utils/aiUsage.ts (Phase 2a — keep local, no shared import)

import type Anthropic from '@anthropic-ai/sdk'

import { useSupabaseAdmin } from './supabase.js'
import { computeCostMicroCents, type AnthropicUsageLike } from './pricing.js'
